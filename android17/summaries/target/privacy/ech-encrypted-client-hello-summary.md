...
- Original statement: targetSdkVersion 37+ のアプリでは TLS connection に ECH が使われ、library / server support が必要。未 negotiated 時は ECH GREASE。`<domainEncryption>` で mode を制御可能。
