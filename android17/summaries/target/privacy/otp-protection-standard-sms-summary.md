...
- 対応する[主レポート](../../../behavior-changes/target/privacy/otp-protection-standard-sms.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
