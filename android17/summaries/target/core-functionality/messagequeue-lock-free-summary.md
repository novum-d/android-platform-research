...
- 対応する[主レポート](../../../behavior-changes/target/core-functionality/messagequeue-lock-free.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
