...
- 対応する[主レポート](../../../behavior-changes/target/security/restrict-pii-fields-cp2-data-view.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
