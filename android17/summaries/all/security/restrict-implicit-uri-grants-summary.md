...
- ゲート結論: Android 17 の検出は feature flag + compat change + StrictMode VM policy 条件。自動 grant 停止の release default は Android 18 側で追加確認が必要。
...
- 対応する[主レポート](../../../behavior-changes/all/security/restrict-implicit-uri-grants.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
