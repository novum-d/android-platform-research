# Local network permission required for apps targeting Android 17 - One Page Summary
...
- Other required conditions: local network access、LAN device discovery / connection、permission grant state、system picker 利用有無。
...
| Android 17 / targetSdkVersion 37 + required conditions | LAN device discovery / connection、mDNS / NSD、casting、IoT、local endpoint socket access が影響を受ける可能性。 |
