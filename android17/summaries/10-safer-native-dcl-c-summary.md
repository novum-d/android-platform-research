# Safer Native DCL-C - One Page Summary
...
- Other required conditions: `System.load()`、native file dynamic loading、native file が read-only として mark されていること。
...
| Android 17 / targetSdkVersion 37 + required conditions | native file が read-only でない場合、`UnsatisfiedLinkError` が発生する。 |
