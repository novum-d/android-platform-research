...
| `platform/art` | `https://android.googlesource.com/platform/art` | `tmp/aosp-checkouts/art/` | 展開中 | `android-16.0.0_r4` / `1690c6912a7972c9e62c39b48c706de9b8b18b4a` | `android-17.0.0_r1` / `b753cf97923c3695338d21466fa14c57b480a59a` | `git -C tmp/aosp-checkouts/art diff --no-renames --name-only android-16.0.0_r4 android-17.0.0_r1` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
| `platform/libcore` | `https://android.googlesource.com/platform/libcore` | `tmp/aosp-checkouts/libcore/` | 展開中 | `android-16.0.0_r4` / `1c599b67bcd3de5c50c79d0622e40b6de99b4cb4` | `android-17.0.0_r1` / `4ebfb391ee0109d16abe6e2bc965724b940928c5` | `git -C tmp/aosp-checkouts/libcore diff --no-renames --name-only android-16.0.0_r4 android-17.0.0_r1` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
