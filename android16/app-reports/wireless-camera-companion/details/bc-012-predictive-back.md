...
- 実装例は [Predictive back implementation examples](../../../behavior-changes/implementation-examples/migration-or-opt-out-required-for-predictive-back-implementation-examples.md) を参照する。
