...
- 実装例は [Predictive back implementation examples](../../../behavior-changes/case-guides/migration-or-opt-out-required-for-predictive-back-implementation-examples.md) を参照する。
