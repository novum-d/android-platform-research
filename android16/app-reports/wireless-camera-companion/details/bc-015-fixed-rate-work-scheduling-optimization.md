...
- [android16/behavior-changes/implementation-examples/fixed-rate-work-scheduling-optimization-implementation-examples.md](../../../behavior-changes/implementation-examples/fixed-rate-work-scheduling-optimization-implementation-examples.md)
...
- Before / After、Timer、Java、テストコードは [Fixed rate work scheduling optimization - 実装例](../../../behavior-changes/implementation-examples/fixed-rate-work-scheduling-optimization-implementation-examples.md) を参照する。
