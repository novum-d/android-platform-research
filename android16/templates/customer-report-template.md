...
コード例、framework 別移行例、temporary opt-out 例が複数必要な場合は、`android16/templates/implementation-examples-template.md` を使って companion implementation examples file を作成し、`android16/behavior-changes/implementation-examples/` に置く。
