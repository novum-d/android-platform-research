...
| `platform/packages/modules/HealthFitness` | `https://android.googlesource.com/platform/packages/modules/HealthFitness` | `tmp/aosp-checkouts/HealthFitness/` | 展開中 | `android-15.0.0_r36` / `99359dc599434b1f00118ab1b701b12afc75cb30` | `android-16.0.0_r4` / `894d57b85aff1a3a854f95397654a1cf0d6a9451` | `git -C tmp/aosp-checkouts/HealthFitness diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
