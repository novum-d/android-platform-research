...
| `platform/system/sepolicy` | `https://android.googlesource.com/platform/system/sepolicy` | `tmp/aosp-checkouts/sepolicy/` | Clean | `android-15.0.0_r36` / `e4a36f4174b17bbab9dc043f4a65dc8d87377290` | `android-16.0.0_r4` / `43e4494a5a78317819dcc2766a11927c12ef3dfd` | `git -C tmp/aosp-checkouts/sepolicy diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | なし。明示タグ比較のため working tree の内容は根拠に含めない。 |
