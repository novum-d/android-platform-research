...
| `platform/packages/apps/Launcher3` | `https://android.googlesource.com/platform/packages/apps/Launcher3` | `tmp/aosp-checkouts/Launcher3/` | 展開中 | `android-15.0.0_r36` / `5a7ed4b586cf4c17e5e5712be68f08283c8e03ae` | `android-16.0.0_r4` / `bbd0e27be08cf2f957b62f5af95669b3203b92a0` | `git -C tmp/aosp-checkouts/Launcher3 diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
| `platform/frameworks/libs/systemui` | `https://android.googlesource.com/platform/frameworks/libs/systemui` | `tmp/aosp-checkouts/systemui-libs/` | Clean | `android-15.0.0_r36` / `5fddbfb7e009894264b76a1354eac5e2a3cf44df` | `android-16.0.0_r4` / `ca0ae237ed2d67f5b05f2572ddbcc6e10b550b92` | `git -C tmp/aosp-checkouts/systemui-libs diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | なし。明示タグ比較のため working tree の内容は根拠に含めない。 |
