...
| `platform/packages/modules/Bluetooth` | `https://android.googlesource.com/platform/packages/modules/Bluetooth` | `tmp/aosp-checkouts/Bluetooth/` | 展開中 | `android-15.0.0_r36` / `810eacb8454c957255fec9328e6e41b30a054033` | `android-16.0.0_r4` / `5323f31677c7dfa04de2e6e9fce1012ef4edaff2` | `git -C tmp/aosp-checkouts/Bluetooth diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
| `platform/packages/apps/Settings` | `https://android.googlesource.com/platform/packages/apps/Settings` | `tmp/aosp-checkouts/Settings/` | 展開中 | `android-15.0.0_r36` / `d56148b315549a7f9759e32565cff83cc9bcc3c1` | `android-16.0.0_r4` / `f6ec09afb00fb635e247687e032c39ed0c1ec21b` | `git -C tmp/aosp-checkouts/Settings diff --no-renames --name-only android-15.0.0_r36 android-16.0.0_r4` | 部分クローンの working tree 展開中。根拠は解決済みタグの object 比較だけを使用し、展開途中のファイルを含めない。 |
