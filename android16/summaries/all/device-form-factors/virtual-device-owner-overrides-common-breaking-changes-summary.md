...
- 対応する[主レポート](../../../behavior-changes/all/device-form-factors/virtual-device-owner-overrides-common-breaking-changes.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
