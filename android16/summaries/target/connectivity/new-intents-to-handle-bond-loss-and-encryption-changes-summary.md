...
- 対応する[主レポート](../../../behavior-changes/target/connectivity/new-intents-to-handle-bond-loss-and-encryption-changes.md)で official section、AOSP project / remote / checkout、解決済み commit、比較 command、dirty risk を再検証した。
